...
# -*- coding: utf-8 -*-
#
# nbsv documentation build configuration file
#
...
project = 'nbsv'
copyright = '2023, Megan Riel-Mehan'
...
_version_py = os.path.join(repo, 'nbsv', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'nbsv.tex', 'nbsv Documentation',
     'Megan Riel-Mehan', 'manual'),
]
